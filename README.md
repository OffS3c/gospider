...
### GO install
```
go install github.com/OffS3c/gospider@latest
```
...
```bash
# Clone the repo
git clone https://github.com/OffS3c/gospider.git

# Build gospider
bash build.sh

# Select gospider according to your OS and run gospider
./gospider -h
```
...
```shell
Fast web spider written in Go - v0.1.1 by @thebl4ckturtle & @j3ssiejjj. Improved by OffS3c.
